...
import me.deathhaven.skywars.utilities.*;
import me.deathhaven.skywars.utilities.IconMenu.OptionClickEvent;
...
public class KitController {
    ...
    public void openKitMenu(final GamePlayer gamePlayer) {
        ...
        IconMenuController.get().create(gamePlayer.getBukkitPlayer(), KIT_MENU_NAME, rowCount, new IconMenu.OptionClickEventHandler() {
            ...
            public void onOptionClick(IconMenu.OptionClickEvent event) {
                ...
                if (isPurchaseAble(kit) && !hasPermission(event.getPlayer(), kit)) {
    ...
    public void openInfoMenu(final GamePlayer gamePlayer) {
    	
    	final Player player = gamePlayer.getBukkitPlayer();
    	
    	IconMenuController.get().create(player, 
    			"Info Menu", 45, new IconMenu.OptionClickEventHandler() {
			public void onOptionClick(OptionClickEvent event) {
				// Just Display Information For Now
			}
		});
    	
    	IconMenuController.get().setOption(player, 0, new ItemStack(Material.ACACIA_DOOR), "Game #1", new String[]{"d","d"});
    	IconMenuController.get().setOption(player, 0, new ItemStack(Material.ACACIA_DOOR), "Game #1", new String[]{"d","d"});
    	IconMenuController.get().setOption(player, 0, new ItemStack(Material.ACACIA_DOOR), "Game #1", new String[]{"d","d"});
    	IconMenuController.get().setOption(player, 0, new ItemStack(Material.ACACIA_DOOR), "Game #1", new String[]{"d","d"});
    	IconMenuController.get().setOption(player, 0, new ItemStack(Material.ACACIA_DOOR), "Game #1", new String[]{"d","d"});
